...
class _HYHomePageState extends State<HYHomePage> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: HYAnimatedIcon(_sizeAnim!),//传入一个Animation
      ),
...
class HYAnimatedIcon extends AnimatedWidget {
  HYAnimatedIcon(Animation animation) : super(listenable: animation);

  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    Animation animation = listenable as Animation;
    return Icon(Icons.favorite,color: Colors.green,size: animation.value,);
  }
}